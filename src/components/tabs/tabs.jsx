    ...
    <div className="movie-card__desc">
      <nav className="movie-nav movie-card__nav">
        <ul className="movie-nav__list"
          ...
          <li className={`movie-nav__item ${activeTab === FilmDetailsTab.DETAILS && `movie-nav__item--active`}`}>
            <a href="#" className="movie-nav__link">Details</a>
          </li>
          <li className={`movie-nav__item ${activeTab === FilmDetailsTab.REVIEWS && `movie-nav__item--active`}`}>
