...
export {Api, AppRoute, ERROR_COLOR, ErrorMessage, ErrorStatusCode, GENRES_COUNT, GO_BACK_MESSAGE, MAX_RATING, MAX_TEXT_LENGTH, MIN_TEXT_LENGTH, SIMILAR_FILMS_COUNT, SHOWING_FILMS_COUNT, SHOWING_FILMS_COUNT_ON_START, ValidationMessage, Video};
